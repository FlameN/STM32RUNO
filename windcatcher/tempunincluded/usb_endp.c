...
extern uint32_t USB_Tx_Bufptr_out;
extern uint32_t USB_Tx_Buf_length;
...
void EP3_OUT_Callback(void)
{
  ...
  uint8 size = RVnetSlaveProcess(USB_Rx_Buffer,VIRTUAL_COM_PORT_DATA_SIZE,1);
  Write_USB(USB_Rx_Buffer,size);
